        ...
        <Container fluid className="contenedor">
            ...
            <img className="studioImagenCopy2" src={studio} alt='img'/>
                ...
                <Card.Text className="copy copy-card copy2-card">
                    ...
                    <h2 className="copySubTitle subtitleCopy2">Beneficios de nuestros servicios</h2>
                    <Fade
                    duration={'2500'}>
                    <Card.Text className="copyText">
                    <ul className="beneficios">
                    <li><span className='tituloCopy'>Diseño Web Moderno:</span> Creamos sitios web funcionales y atractivos que reflejan la esencia de tu marca </li>
